...
enum RBACPermissions
{
	...
	RBAC_PERM_COMMAND_WORLDCHAT								= 1015,
	RBAC_PERM_COMMAND_WORLDCHAT_RELOAD						= 1016,
	RBAC_PERM_COMMAND_ANTICHEAT								= 1017,
	RBAC_PERM_COMMAND_ANTICHEAT_ADMIN						= 1018,
	RBAC_PERM_COMMAND_FILTRO								= 1019,
	RBAC_PERM_COMMAND_PROMO									= 1020,
		
	//Arena Spectator
	RBAC_PERM_COMMAND_SPECTATE								 = 1021,
	RBAC_PERM_COMMAND_SPECTATE_PLAYER						 = 1022,
	RBAC_PERM_COMMAND_SPECTATE_VIEW							 = 1023,
