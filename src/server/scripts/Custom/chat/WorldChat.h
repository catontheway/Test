...
string Canal = "Mundo";
string ColorBase = "9bf943";
string GM_ICON = "|TINTERFACE/CHATFRAME/UI-CHATICON-BLIZZ:13:13:0:-1|t";
string Alianza = "|TInterface\\icons\\Inv_Misc_Tournaments_banner_Human.png:13|t";
string Horda = "|TInterface\\icons\\Inv_Misc_Tournaments_banner_Orc.png:13|t";
